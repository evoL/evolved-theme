...

{
  ...
  colors: {
    ...
    'statusBarItem.remoteHoverForeground': d.fg.cornerHover,
    // Title bar
    ...
    'panelSection.dropBackground': d.bg.selection + alpha(30),
    'panelSectionHeader.background': d.bg.ui,
    ...
    'editorWidget.foreground': d.fg.elevatedUi,
    ...
    'editor.selectionHighlightBackground': d.bg.selectionHighlight,
    'editor.selectionHighlightBorder': d.outline.selectionHighlight,
